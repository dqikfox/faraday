...
namespace RealityEngine.EditorTools
{
    public static class LabLandscapeMenu
    {
        ...
        {
            Place(GizaComplex.Spawn.All, "FULL Giza complex force-rebuild: pyramids, temples, causeways, West/East/Central Field mastabas, Khentkawes I, workers village + Wall of the Crow, Osiris Shaft, dunes, Nile harbor, desert dust. Reality Engine / Place Giza Complex.");
        }
        ...
        static void Place(GizaComplex.Spawn which, string detail)
        {
            ...
            Mark(applier);
            Selection.activeGameObject = applier != null ? applier.gameObject : null;
            Debug.Log("Reality Engine: placed " + detail + " Roots: KhufuWestField, GizaCentralField, Khentkawes, GizaWorkersVillage, OsirisShaft, GizaDesertDust, GizaNileHarbor, LabLandscape.");
        }
