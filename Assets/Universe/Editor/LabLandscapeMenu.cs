...
namespace RealityEngine.EditorTools
{
    public static class LabLandscapeMenu
    {
        ...
        static void Place(GizaComplex.Spawn which, string detail)
        {
            ...
            Mark(applier);
            Selection.activeGameObject = applier != null ? applier.gameObject : null;
            Debug.Log("Reality Engine: placed " + detail + " Roots: KhufuWestField, Hemiunu, Senedjemib, Ankhhaf, Kawab, Meresankh, Debehen, MenkaureQuarry, GisrElMudir, KhufuTrialPassages, GizaCentralField, Khentkawes, GizaWorkersVillage, OsirisShaft, GizaSurveyAnomalies, GizaDesertDust, GizaNileHarbor, LabLandscape.");
        }
